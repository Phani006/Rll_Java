...
public interface AssignRepository extends JpaRepository<Assign, Integer> {
	...
	@Query(value = "select * from assign where employee_ref_employee_id=:employeeId",nativeQuery = true)
	public Assign getAssignedEmployeeCourses(@Param("employeeId")int employeeId);
